...
export const GET_SALE_BY_DAY_REQUEST = "GET_SALE_BY_DAY_REQUEST";
export const GET_SALE_BY_DAY_FAILURE = "GET_SALE_BY_DAY_FAILURE";
export const GET_SALE_BY_DAY_SUCCESS = "GET_SALE_BY_DAY_SUCCESS";

export const GET_SALE_BY_MONTH_REQUEST = "GET_SALE_BY_MONTH_REQUEST";
export const GET_SALE_BY_MONTH_FAILURE = "GET_SALE_BY_MONTH_FAILURE";
export const GET_SALE_BY_MONTH_SUCCESS = "GET_SALE_BY_MONTH_SUCCESS";
